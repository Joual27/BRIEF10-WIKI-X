<nav class="bg-white border-gray-200 dark:bg-gray-900 ">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
        <a href="<?= URLROOT ?>/pages" class="block py-2 px-3 md:p-0 text-white bg-violet-400 rounded md:bg-transparent md:text-blue-700 md:dark:text-violet-400" aria-current="page">Home</a>
      </li>
      <li>
        <a href="<?= URLROOT ?>/AUTHOR/Wikis" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-violet-400 md:dark:hover:text-violet-400 dark:text-white dark:hover:bg-gray-700 dark:hover:text-violet-400 md:dark:hover:bg-transparent dark:border-gray-700">WIKIS</a>
      </li>
      <li>
        <a href="<?= URLROOT ?>/AUTHOR/Wikis" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-violet-400 md:dark:hover:text-violet-400 dark:text-white dark:hover:bg-gray-700 dark:hover:text-violet-400 md:dark:hover:bg-transparent dark:border-gray-700">CATEGORIES</a>
      </li>
  ...
  <div id="dropdown" class="absolute hidden z-10 right-[17%] top-[8%] bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
    <div class="px-4 py-3 text-sm text-gray-900 dark:text-white">
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownInformationButton">
                          <li>
                            <a href="<?= URLROOT ?>/author/wikisOfAuthor" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">My Wikis</a>
                          </li>
                          <li>
                            <a href="<?= URLROOT ?>/author/postWiki" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Post New Wiki</a>
                          </li>
                          <li>
                            <a href="<?= URLROOT ?>/author/wikisOfAuthor" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit Profile</a>
                          </li>
